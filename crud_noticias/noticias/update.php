...
if($_POST) {
    ...
    if ($tipo == "1")
    {
    $sql = "UPDATE noticias SET titulo = '$cr_titulo', par1 = '$cr_par1', img1 = '$cr_img1', par2 = '$cr_par2', img2 = '$cr_img2', par3 = '$cr_par3', img3 = '$cr_img3', par4 = '$cr_par4', img4 = '$cr_img4', preview = '$cr_preview' WHERE id_noticia = {$id}";
    }
    else
