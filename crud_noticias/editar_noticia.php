...
{
$sql = 'SELECT id_noticia,titulo,par1,img1,par2,img2,par3,img3,par4,img4,original_poster,preview from noticias where id_noticia =' .$id;
}
...
echo 'Preview: <input type="text" name="preview" value="'.$dados['preview'].'"></br>';
