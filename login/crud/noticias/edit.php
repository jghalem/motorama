...
$sql = 'SELECT id_noticia,titulo,par1,img1,par2,img2,par3,img3,par4,img4 from noticias where id_noticia ='.$_GET['id'];
...
echo '<input type="hidden" name="id" value="'.$dados['id_noticia'].'">';
