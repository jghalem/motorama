...
if($_POST) {
    ...
    {
    $sql = "INSERT INTO noticias (titulo, par1, img1, par2, img2, par3, img3, par4, img4, original_poster) VALUES ('$cr_titulo', '$cr_par1', '$cr_img1', '$cr_par2', '$cr_img2', '$cr_par3', '$cr_img3', '$cr_par4', '$cr_img4', '{$_SESSION["id_usuario"]}')";
    }
