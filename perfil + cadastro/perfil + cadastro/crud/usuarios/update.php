...
if($_POST) {
    ...
    $sql = "UPDATE usuarios SET nome = '$cr_nome', username = '$cr_username', senha = '$cr_senha', email = '$cr_email', data_nasc = '$cr_data_nasc', data_conta = '$cr_data_registro', foto = '$cr_foto' WHERE id_usuario = {$id}";
